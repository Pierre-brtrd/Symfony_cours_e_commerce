...
/**
 * Class filter for the products page in ajax
 *
 ...
 * @property {HTMLElement} count - the element with the number total of products
...
export class Filter {
    ...
    constructor(element) {
        ...
        this.moreNav = this.page === 1 && this.page < parseInt(this.content.dataset.totalPage);
    ...
    bindEvents() {
        ...
        this.form.querySelectorAll('input[type="checkbox"], input[inputmode="decimal"]').forEach(input => {
